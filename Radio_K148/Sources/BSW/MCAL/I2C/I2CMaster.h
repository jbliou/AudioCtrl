 ...
 */
    ...
    typedef void (* I2C_State_Process)(void) ;
        ...
        const I2C_State_Process pHandleI2C[] = {
            Handle_I2C_STATE_INIT ,
            Handle_I2C_STATE_IDLE ,
            Handle_I2C_STATE_WAIT ,
            Handle_I2C_STATE_WRITE ,
            Handle_I2C_STATE_WRITE_START ,
            Handle_I2C_STATE_WRITE_FINISHED ,
            Handle_I2C_STATE_READ ,
            Handle_I2C_STATE_READ_START ,
            Handle_I2C_STATE_READ_FINISHED ,
            Handle_I2C_STATE_WRITE_THEN_READ ,
            Handle_I2C_STATE_WRITE_THEN_READ_START_WRITE ,
            Handle_I2C_STATE_WRITE_THEN_READ_FINISHED_WRITE ,
            Handle_I2C_STATE_WRITE_THEN_READ_START_READ ,
            Handle_I2C_STATE_WRITE_THEN_READ_FINISHED_READ ,
        };
